        ...
        <div class="container">
            <div class="row">
                 ...
                 <div class="top-tabs p-0 mb-4">
                    <h2 class='py-3 py-lg-5 text-maroon'>Settings <span @click="openSlideBar = !openSlideBar" :aria-pressed="openSlideBar ? 'true' : 'false'" class="open-tabs"><i class="fa fa-bars"></i></span> </h2>
                </div>
