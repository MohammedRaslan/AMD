<template>
    ...
    <section class="shopping-cart step2">
        <div class="container">
                        ...
                        <div class="inner-step shop-cart row">
                            <div class="col-2 icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="19.963" height="17.986" viewBox="0 0 19.963 17.986">
                                    <g id="Icon_20_Grey_Shopping_Cart" data-name="Icon / 20 / Grey / Shopping Cart" transform="translate(0 -1.009)">
                                        <path id="Shape" d="M2.252,4.742H4L1.408.369A.759.759,0,0,0,.375.1.731.731,0,0,0,.1,1.118Z" transform="translate(11.776 1.009)" fill="#ffe0e0"/>
                                        <path id="Shape-2" data-name="Shape" d="M3.9,1.116A.735.735,0,0,0,3.627.1.762.762,0,0,0,2.594.367L0,4.744H1.75Z" transform="translate(4.193 1.011)" fill="#ffe0e0"/>
            ...
            <div class="row">
               <div class="col-lg-5 save" id="radio_1">
                    <div class="inner-save">
                        <div class="body-save p-4 pt-2">
                            <p class="old-adress">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget d
                                olor. Aene
                            </p>
                        </div>
                    </div>
                   ...
                   <div class="inner-save">
                         <form action="">                            
                             <div class="row g-3">
                                ...
                                <div class="col-md-6 col-12">
                                    <input class="form-control" type="text" aria-label="Last name" placeholder="Last name" disabled required>
                                </div>
                            </div>
                             <div class="row g-3">
                                 <div class="col">
                                    <input class="form-control" type="text" aria-label="Country" placeholder="Country" disabled required>
                                </div>
                                <div class="col">
                                    <input class="form-control" type="text" aria-label="State" placeholder="State" disabled required>
                                </div>
                            </div>
                             <div class="row g-3">
                                 <div class="col-lg-3">
                                    <input class="form-control" type="number" aria-label="zip code" placeholder="Zip Code" disabled required>
                                </div>
                                <div class="col-lg-9">
                                    <input class="form-control" type="text" aria-label="city" placeholder="City" disabled required>
                                </div>
                            </div>
                             <div class="row g-3">
                                 <div class="col">
                                    <input class="form-control" type="text" aria-label="Address 1" placeholder="Address 1" disabled required>
                                </div>
                            </div>
                             <div class="row g-3">
                                 <div class="col">
                                    <input class="form-control" type="text" aria-label="Address 2" placeholder="Address 2" disabled>
                                </div>
                            </div>
                             <div class="row g-3 d-flex justify-content-end">
                                   <button class="btn btn-secondary btn-lg" disabled type="submit">Continue</button>
                            </div>
                        </form>
                   </div>
               </div>
