                    ...
                    <div class="cont-pro" v-for="product in cartProducts" :key="'row_'+product.id" :id="'row_'+product.product.id">
                        <div class="inner-pro">
                            <div class="row">
                                <div class="col-5">
                                    <figure>
                                        <img :src='str_replace(product.product.image)' alt="">
                                    </figure>
                                </div>
                                <div class="col-7">
                                    <div class="detail">
                            ...
                            <div class="close" @click="removeFromCart(product.product.id,product.product.best_offer)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="15.556" height="15.556" viewBox="0 0 15.556 15.556">
                                    <g id="Icon_20_Grey_Close" data-name="Icon / 20 / Grey / Close" transform="translate(-2.222 -2.222)">
                                        ...
                                        <rect id="Rectangle_4-2" data-name="Rectangle 4" width="20" height="2" rx="1" transform="translate(2.222 16.364) rotate(-45)" fill="#ffe0e0"/>
                                    </g>
                                </svg>
                            </div>
                        </div>
