        ...
        <div class="container">
            <div class="row">
                ...
                <div class="top-tabs p-0 mb-4">
                    <h1 class='py-3 py-lg-5 text-yellow'>Archive<span @click="openSlideBar = !openSlideBar" :aria-pressed="openSlideBar ? 'true' : 'false'" class="open-tabs"><i class="fa fa-bars"></i></span> </h1>
                </div>
                ...
                <div class="col-xl-10 col-md-12">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="inner-content">
                             <h3 class="text-center text-yellow">You have no Archive</h3>
