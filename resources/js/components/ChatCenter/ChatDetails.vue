      ...
      <div class="container">
        <div class="row">
            ...
            <div class="top-tabs p-0 mb-4">
                <h1 class='py-3 py-lg-5 text-yellow'>Chat Details<span @click="openSlideBar = !openSlideBar" :aria-pressed="openSlideBar ? 'true' : 'false'" class="open-tabs"><i class="fa fa-bars"></i></span> </h1>
            </div>
            ...
            <div class="col-xl-10 col-md-12 mt-3 mt-lg-0 px-3 chat-private">
                ...
                <div class="inner-content p-2">
                    <div class="">
                        <div class="text-maroon pl-0 mb-3 d-flex align-items-center">
                            <div class="seller-avatar mr-2">
                                <img src="/FrontEnd/images/avatars/avatars-10-colored.jpg" alt="">
                            </div>
                            {{ user_name }}
                        </div>
                        <div class="p-0" >
