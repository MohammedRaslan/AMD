        ...
        <div class="container">
            ...
            <!-- End Component  -->
                <div class="col-xl-10 col-md-12">
                    ...
                    <div class="tab-content" id="v-pills-tabContent" v-for="wishlist in wishlists" :key="wishlist.id">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-md-12 btns">
                                           <div class="inner-gruop">
                                                  ...
                                                  <div class="inner" >
                                                    <button class="btn btn-secondary"><router-link :to="{name: 'ProductCreateStepTwo', params:{id: wishlist.product.id}}">View</router-link></button>
                                                </div>
                                                <div class="inner">
