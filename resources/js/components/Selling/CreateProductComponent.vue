                            ...
                            <div class="inner-content p-0">
                                ...
                                >
                                    ...
                                    <div class="inner-item">
                                        <div class="row">
                                            <div
                                                class="col-lg-12 detalis border-0 sell-an-item-section p-0"
                                            >
                                                <div
                                                    class="signup bg-transparent"
                                                >
                                                    <div class="container p-2">
                                                        <div
                                                            class="row text-center pt-0"
                                                        >
                                                            <div
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div
                                                                            class="row pb-4 pr-sm-0"
                                                                        >
                                                                            <div
                                                                                class="col-lg-6 select-product text-left mb-4 pr-sm-0"
                                                                            >
                                                                                <label
                                                                                    class="text-white"
                                                                                    for="cats"
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <UploadImages
                                                                                ...
                                                                                uploadMsg="Upload Item Images (up to 12 image)"
                                                                        ...
                                                                        <div
                                                                            class="col-12 mb-5 description text-left"
                                                                        >
                                                                            <label
                                                                                for="#description"
                                                                                style="color:white"
                                                                        ...
                                                                        <div
                                                                            class="row listing-type"
                                                                        >
                                                                            <h3
                                                                                class="text-left text-maroon mt-3"
                                                                            >
                                                                                Selling
                                                                                Format
                                                                                <span
                                                                            ...
                                                                            <nav>
                                                                                <div
                                                                                    class="nav nav-tabs mt-3 border-0 row"
                                                                                    id="nav-tab"
                                                                                    role="tablist"
                                                                                >
                                                                                    <div
                                                                                        class="nav-link col active"
                                                                                        id="nav-home-tab"
                                                                                        data-bs-toggle="tab"
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    >
                                                                                        <div
                                                                                            class="col-lg-6 d-flex align-items-center justify-content-center h-100"
                                                                                        >
                                                                                            <div
                                                                                                class="inner-save inner-save1 w-100"
                                                                                            >
                                                                                                <form
                                                                                                    action=""
                                                                                                    class="border-0 px-0"
                                                                                        ...
                                                                                        >
                                                                                            <div
                                                                                                class="round round-3 pl-3 minimum-offer"
                                                                                            >
                                                                                                <input
                                                                                                    type="checkbox"
                                                                                                    v-model="
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <div
                                                                                class="collapse m-3 additional-information p-0"
                                                                                id="collapseExample"
                                                                            >
                                                                                <div
                                                                                    class="card card-body background-color border-0 p-0"
                                                                                >
                                                                                    <div
                                                                                        class="row text-left"
                                                                                    >
                                                                                        ...
                                                                                        >
                                                                                            ...
                                                                                            >
                                                                                                ...
                                                                                                <input
                                                                                                    ...
                                                                                                    class="form-control"
                                                                                                    id="fName"
                                                                                                    placeholder="Featured Refinements"
                                                                                                />
                                                                                                <div
                                                                                                    v-if="
                                                                                                        form.errors.has(
                                                                        ...
                                                                        >
                                                                            <input
                                                                                ...
                                                                                "
                                                                                value="Save as Draft"
                                                                                class="form-control btn btn-milky bg-gray"
                                                                                id="draft"
                                                                            />
                                                                        </div>
                                                                        <div
...
export default {
    ...
    methods: {
        async saveProduct() {
            this.$Progress.start();
            this.form.minimum_offer =
                this.form.best_offer == false ? null : this.form.minimum_offer;
            this.form.best_offer = this.form.best_offer == true ? 1 : 0;
            this.form.domestic_product =
                this.form.domestic_product == true ? 1 : 0;
            this.form.modified_item = this.form.modified_item == true ? 1 : 0;
            this.form.type =
                this.form.bidding_from || this.form.bidding_to != null ? 1 : 0;
            this.form.price =
                this.form.bidding_from != null || this.form.bidding_to != null
                    ? 0
                    : this.form.price;
            if (jQuery.isEmptyObject(this.form.image)) {
                ...
                const response = await this.form
                    ...
                    .then(response => {
                        ...
                        this.form.reset();
                        this.$router.push(
                            "/product_shipping/" + response.data.product_id
                        );
                    })
                    .catch(error => {
                        this.$Progress.fail();
