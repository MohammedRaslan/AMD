                                ...
                                >
                                  <div class="row">
                                    <div class="col-12 text-left">
                                      <label class="text-white" for="fName"
                                        >Item Name
                                    ...
                                    <div class="row pb-4 pr-sm-0">
                                      <div
                                        ...
                                        "
                                      >
                                        <label class="text-white" for="cats"
                                          >Category
                                          <span class="requiredItem"
                                            >*</span
                                          ></label
                                      ...
                                      <div
                                        ...
                                        "
                                      >
                                        <label class="text-white" for="brand"
                                          >Brand
                                          <span class="requiredItem"
                                            >*</span
                                          ></label
                                    ...
                                    <div class="row listing-type">
                                      <h3 class="text-left text-maroon mt-3">
                                        Selling Format
