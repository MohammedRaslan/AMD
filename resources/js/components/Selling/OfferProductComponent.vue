                          ...
                          <div class="container p-2">
                            <div class="row text-center pt-0">
                              <div class="col-lg-12 col-md-12 col-sm-12">
                                <h2 class="pb-3 pt-0 sub-title text-offwhite">
                                  Product Info
                                </h2>
                                <form
                                ...
                                >
                                  <div class="row">
                                    <div class="col-12 text-left">
                                      <label class="text-offwhite" for="fName"
                                        >Item Name
                                        <span class="requiredItem text-maroon"
                                          >*</span
                                        ></label
                                      >
                                      <input
                                    ...
                                    <div
                                      ...
                                      "
                                    >
                                      <label class="text-offwhite" for="brand"
                                        >Brand
                                        <span class="requiredItem text-maroon"
                                          >*</span
                                        ></label
                                    ...
                                    >
                                      ...
                                      <button
                                        type="button"
                                        class="btn btn-milky w-100 pb-2"
                                        @click="changeOptionalImages"
                                      >
                                  ...
                                  <div>
                                    <a
                                      class="btn btn-milky mb-4 w-100"
                                      ...
                                      >
                                        <div class="row text-left">
                                          <div class="col-lg-4">
                                            ...
                                            <div
                                              v-if="
                                                form.errors.has('doll_size')
                                              "
                                              class="alert alert-danger"
                                              v-html="
                                                form.errors.get('doll_size')
                                              "
                                            />
                                          </div>
                                          <div class="col-lg-4">
                                          ...
                                          <div class="col-lg-4">
                                            ...
                                            <v-select
                                              ...
                                              v-model="form.doll_gender"
                                              :options="gender"
                                            ></v-select>
                                            <div
                                              v-if="
                                                form.errors.has('doll_gender')
                                              "
                                              class="alert alert-danger"
                                              v-html="
                                                form.errors.get('doll_gender')
                                              "
                                            />
                                          </div>
                                          <div class="row my-3">
...
export default {
  ...
  data: () => ({
    ...
    form: new form({
      title: null,
      type: 2, // type 0 => Regular , type 1 => Bidding
      condition: null,
      image: {},
      brand: null,
      description: null,
      ...
      if (jQuery.isEmptyObject(this.form.image)) {
        ...
        const response = await this.form
          ...
          .then((response) => {
            ...
            this.$router.push("/offer_shipping/" + response.data.product_id);
          })
          .catch((error) => {
            this.$Progress.fail();
            console.log(error);
  ...
  mounted() {
    ...
    this.$Progress.finish();
    axios
      .get("/api/product/getProductData/" + this.$route.params.id)
      .then((response) => {
