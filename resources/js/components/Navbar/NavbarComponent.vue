<template>
    <div>
        ...
        <ul
            class="text-start d-lg-flex d-xl-flex d-md-flex justify-content-between d-flex links-header-mobil"
            v-if="logged"
        >
            <!-- <li
...
export default {
    ...
    mounted() {
        if (localStorage.getItem("token")) {
            ...
            this.email = JSON.parse(localStorage.getItem("currentUser"))[
                "email"
            ];
