...
>
        ...
        >
            ...
            <router-link to="/help">
                <div class="mesg" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Messages">
                    ...
                    <svg width="22" height="22" fill="#fff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                        <g>
                            <g>
    ...
    L1.024,404.992C3.488,420.192,16.096,432,32,432h448c15.904,0,28.512-11.808,30.976-27.008L310.08,277.952z">
            ...
            <router-link to="/buying/wishlist">
              <svg fill="#fff" stroke="#fff" xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 34 34" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Favourits">
                                            <g id="Group_37" data-name="Group 37" transform="translate(-784 -317)">
                                                ...
                                                <g id="Ellipse_48" data-name="Ellipse 48" transform="translate(784 317)"
            ...
            <div class="dropdown drop-user1">
                ...
                <img v-show="image" style="width: 45px;border-radius: 50%;margin-left:5px;" :src="image" alt="">
                </button>
                <ul
                ...
                <li>
                    <router-link to="/selling/overview" class="dropdown-item">Selling</router-link>
                </li>
                <li>
                    <router-link to="/buying/offers" class="dropdown-item">Looking to buy</router-link>
                </li>
                <li>
                    <router-link to="/buying/wishlist" class="dropdown-item">Watching</router-link>
                </li>
                <li>
                    <router-link to="/selling/overview" class="dropdown-item">Purchases</router-link>
                </li>
                <li>
                    <router-link to="/selling/overview" class="dropdown-item">Buy Again</router-link>
                </li>
                <li>
                    <router-link to="/selling/wishlist" class="dropdown-item">Saved</router-link>
                </li>
                <li>
                    <router-link to="/selling/overview" class="dropdown-item">Recently Viewed</router-link>
                </li>
                <li>
                    <router-link to="/help" class="dropdown-item">Help and Support</router-link>
                </li>
                <li>
                    <router-link class="dropdown-item" to="/selling/seller_details">Settings</router-link>
                </li>
                <li>
        ...
        >
            ...
            <div class="canvas__open" :class="{ 'canvas__open_guest' : this.logged != true}">
                <span></span>
                <span></span>
                <span></span>
            </div>
