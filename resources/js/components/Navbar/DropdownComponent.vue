<template>
    <div class="dropdown drop-1" :class="{ 'borderrad': dropCategories }" >
        <button class="btn btn-outline-secondary dropdown-toggle marketplace-categories" v-on:click="clickDropCategories()">
            <span>Marketplace22</span>
                <svg id="Icon_down_solid" xmlns="http://www.w3.org/2000/svg" style="width: 22px" width="20.833" height="20.833" viewBox="0 0 20.833 20.833"  :class="{ 'svg-tran': dropCategories }" >
