<template>
    ...
    <i class="fas fa-search fs-20 text-white"></i>
    <!-- <svg fill='#fff' stroke='#fff' xmlns="http://www.w3.org/2000/svg" width="20" height="37" viewBox="0 0 19.944 19.945">
        <g id="Icon_20_Grey_Search" data-name="Icon / 20 / Grey / Search"
