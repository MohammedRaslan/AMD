    ...
    <div class="projects m-3">
        <div class="tableFilters row m-4">
            ...
            <div class="control col-6">
                <div class="select">
                    <select class="form-control" v-model="tableData.length" @change="getFaqs()">
        ...
        <pagination :pagination="pagination"
                    @prev="getFaqs(pagination.prevPageUrl)"
                    @next="getFaqs(pagination.nextPageUrl)">
        </pagination>
    </div>
...
export default {
    ...
    methods: {
        ...
        async changeStatus(id){
            this.$Progress.start();
            const response = await axios.get('/api/faq/changeStatus/'+id).then((response) =>{
        ...
        async CreateFaq(){
            ...
            const result = await this.form.post('/api/faq/store').then((response) => {
