...
<template>
    <nav class="pagination" v-if="!client">
        ...
        <a v-if="pagination.prevPageUrl" class="button btn btn-primary is-small pagination-previous" @click="$emit('prev');">
            Prev
        </a>
        <a class="button is-small btn btn-primary pagination-previous" v-else :disabled="true">
           Prev
        </a>

        <a v-if="pagination.nextPageUrl" class="button btn btn-primary is-small pagination-next" @click="$emit('next');">
            Next
        </a>
        <a class="button is-small btn btn-primary pagination-next" v-else :disabled="true">
            Next
        </a>
    </nav>
