    ...
    <div v-show="logged">
        <section class="hero" style="background:url(/FrontEnd/images/home-logged-banner.jpg);background-repeat: no-repeat; background-size: cover; height: 500px; position: relative;">
            ...
            <div class="container-fluid" style="background: rgba(0, 0, 0, 0.9); height: 100%; position: absolute;left: 0; top: 0;">
                ...
                <div class="row home-logged">
                    <div class="col-5 buy-side">
                        <!-- <a href="dollshouse.html" class="green">
                    ...
                    <div class="col-5 sell-side">
                        <!--<a href="#" class="pink">Sell</a>-->
                        <router-link to="/selling/sell_item" class="pink">
                            <button class="pink" style="padding: 9px 57px 8px ;">Sell</button>
                        </router-link>
                    </div>
                </div>
            </div>
