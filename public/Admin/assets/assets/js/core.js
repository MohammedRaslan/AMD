jQuery(document).ready(function($){
    ...
    if($('body').hasClass('iconcolor')) {
        $('.btn-iconcolor').prop('checked',true);
    }else{
        $('body').removeClass('iconcolor');
        $('.btn-iconcolor').prop('checked',false);

    }

    if($('body').hasClass('gradient')) {
        $('.btn-gradient').prop('checked',true);
    }else{
        $('body').removeClass('gradient');
        $('.btn-gradient').prop('checked',false);
    }
    ...
    if($('body').hasClass('boxlayout')) {
        $('.btn-boxlayout').prop('checked',true);
    }else{
        $('body').removeClass('boxlayout');
        $('.btn-boxlayout').prop('checked',false);
    }
